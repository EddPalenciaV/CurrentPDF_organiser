...
folder_Civil = current_Date + " CIVIL"
# Create civil folder with date
folder_Arch = current_Date + " ARCHITECTURE"
# Create civil folder with date
...
def organise_C_alphabetical():
    ...
    ss_directory = os.path.join(directory, "_SS", folder_Civil)
...
def organise_A_alphabetical():
    ...
    # Ensure the _SS directory exists
    ss_directory = os.path.join(directory, "_SS", folder_Arch)
    os.makedirs(ss_directory, exist_ok=True)
